...
public final class CMFactory {
    ...
    public static int getSpacesForCentering(String message) {
        ...
        for (char c : message.toCharArray()) {
            if (c == '§') {
                ...
                DefaultFontSize dFI = DefaultFontSize.getDefaultFontSize(c);
                messagePxSize += isBold ? dFI.getBoldLength() : dFI.getLength();
                messagePxSize++;
            }
        }
        ...
        return (CENTER_PX - halvedMessageSize) / spaceLength;
    }
